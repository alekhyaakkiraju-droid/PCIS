# Keycloak 26.x OIDC IdP (WO-145) — gated until EKS + Helm providers can authenticate
# and Secrets Manager values are populated out-of-band.
...
variable "keycloak_ingress_host" {
  type    = string
  default = "auth.dev.pcis.example.com"
}
