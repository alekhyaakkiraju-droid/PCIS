...
/**
 * Propagates X-Correlation-ID into MDC for distributed log correlation.
 * Generates a UUID when the header is absent. MDC is cleared after response
 * to prevent thread-local leaks in pooled Servlet containers.
 */
@Component
public class CorrelationIdFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      MDC.put(MDC_SERVICE, "claims-svc");
