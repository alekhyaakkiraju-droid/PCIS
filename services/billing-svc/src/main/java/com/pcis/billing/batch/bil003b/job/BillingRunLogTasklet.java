package com.pcis.billing.batch.bil003b.job;
...
public class BillingRunLogTasklet implements Tasklet {
  ...
  public BillingRunLogTasklet(JdbcTemplate jdbcTemplate, BillingGenerationProperties properties) {
